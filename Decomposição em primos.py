...
"O objetivo deste código é desenvolver uma função cuja entrada será um número inteiro arbitrário e retorna seu "
" máximo fator primo, podendo também apresentar sua decomposição nesses fatores."


def prime_dec(n, flag=True):
    """
    ...
    flag - condição booleana para apresentação completa dos fatores primos presentes na decomposição de n.
    o valor padrão é True para esse parâmetro.
    ...
    if int(n) == 1:
        'Caso não deseje ver a lista de fatores primos e seus expoentes, considere o parâmetro flag = False.'
        if flag:
    ...
    # o processo do último primo encontrado até ([n/2] + 1) garantindo assim todos os possíveis fatores primos de n.
        ...
        'Caso não deseje ver a lista de fatores primos e seus expoentes, considere o parâmetro flag = False.'
        if flag:
            print('A lista de fatores primos e seus respectivos expoentes na decomposição de {} são: {},{}'.format(
                Check_N, Lista_de_primos, Expoentes))
